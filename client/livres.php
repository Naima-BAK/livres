...
if(!empty($_POST)){
  ...
  if(!empty($_POST['searchTitre']) && empty($_POST['searchAuteur']) && empty($_POST['searchPrix'])){
      $livres = searchLivreName($_POST['searchTitre']);
  } 
  ...
  elseif(empty($_POST['searchTitre']) && empty($_POST['searchAuteur']) && !empty($_POST['searchPrix'])){
     ...
     if($_POST['searchPrix'] == 'prix bas'){
      $livres = searchLivrePrixBas();
     }else{
      $livres = searchLivrePrixEleve();
     }
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <a href="livres.php"> <li data-filter="*" class="filter-active">Tout</li></a>
              <?php  
