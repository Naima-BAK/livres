...
function getAllMessages(){      
    ...
    $requet = "SELECT g.message,g.date,g.user_id,user.nom,user.prenom,user.image from messages g,utilisateur user where g.user_id=user.id";
    $result = $conn->query($requet);
    $groupes = $result->fetchAll();
    return $groupes;
  }
$groupes = getAllMessages();
if(isset($_POST['add'])){
    contactAdmin();
            ...
            <div id="plist" class="people-list">
                ...
                <ul class="list-unstyled chat-list mt-2 mb-0">
                   ...
                   <li class="clearfix" style="background-color:#d7f5fc">
                        <img src="../admin/static/img/imgUsers/<?php echo  $user['image'];?>" alt="avatar">
                        <div class="about">
                            <div class="name"><?php echo $user['nom'].''.$user['prenom'] ?></div>
                        </div>
                    </li>
                    ...
                    <!-- ------------------ ------------------- -->
                        ...
                        <div class="col-lg-6">
                           <a href="javascript:void(0);" data-toggle="modal" data-target="#view_info">
                            ...
                            <div class="about">
                               <div class="name"><?php echo $user['nom'].''.$user['prenom'] ?>
                               </div>
                           </div>
                        </div>
                    <!-- ------------------------------------------------ -->
