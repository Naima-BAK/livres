...
if(!isset($_SESSION['name'])){
  ...
  header("location:login.php");
   ...
   function getAllGroupes2(){      
  $conn = DBconnexion();

  $requet = "SELECT g.message,g.date,g.user_id,user.nom,user.prenom,user.image from groupes2 g,utilisateur user where g.user_id=user.id";
  $result = $conn->query($requet);
  $groupes = $result->fetchAll();
  return $groupes;
}
$groupes = getAllGroupes2();
    ...
    <div class="row">
        ...
        <div style="background-color: white;border:none;width:1200px;margin-left:76px"  class="card mb-4">
            <h5 style="padding: 1.5rem 1.5rem; margin-bottom: 0;margin-right:1000px;background-color: transparent; border-bottom: 0 solid #d9dee3;"  class="card-header">
               <b style="font-size:17px;color: #71dd37 !important;"> INTERKHRISTOUS </b>
                <!-- <p > text about book</p>
...
<link rel="preconnect" href="https://fonts.googleapis.com" />
 ...
 <div class="content-wrapper">
           ...
           <form action="groupe2.php" method="post">
