        ...
        ?>
           ...
           <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                 ...
                 <h5 class="card-header" style="background-color: white !important;"><b><span style="background-color:  #ffe0db !important;  color:#ff3e1d  !important;font-size:large;">Gestion des livraisons</span></b>
                                 ...
                                 print'
                                     <tr>
                                          ...
                                          <a  href="showLivraison.php?id='.$l['id'].'"> <svg   xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffab00" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                             ...
                                             &nbsp;
                                             <a href="traitementLivraison.php?id='.$l['id'].'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
